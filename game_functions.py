...
def check_events(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            mouse_x, mouse_y = pygame.mouse.get_pos() # Получаем координаты мыши и сохраняем в переменных
...
def update_aliens(ai_settings, stats, screen, sb, ship, aliens, bullets):
    ...
    # Прверка пришельцевб добравшихся до нижнего края экрана.
...
def ship_hit(ai_settings, stats, screen, sb, ship, aliens, bullets):
    ...
    if stats.ships_left > 0:
        ...
        stats.ships_left -= 1
        # Обновление оставшихся звездолетов
        sb.prep_ships()
        ...
        pygame.mouse.set_visible(True) # Возвращает указатель мыши
